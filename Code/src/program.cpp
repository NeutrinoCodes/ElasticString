...
void setup()
{
  ...
  for (i = 0; i < NUM_POINTS; i++)
  {
    ...
    stiffness->x[i] = k;                                   // Setting "x" stiffness...
    stiffness->y[i] = k;                                   // Setting "y" stiffness...
    stiffness->z[i] = k;                                   // Setting "z" stiffness...
    ...
    friction->x[i] = c;                                        // Setting "x" friction...
    friction->y[i] = c;                                        // Setting "y" friction...
    friction->z[i] = c;                                        // Setting "z" friction...
    friction->w[i] = 1.0f;                                         // Setting "w" friction...

    mass->x[i] = m;                                             // Setting "x" mass...
    mass->y[i] = m;                                             // Setting "y" mass...
    mass->z[i] = m;                                             // Setting "z" mass...
  ...
  freedom->init();
  dt->init();                                                              // Initializing kernel variable...
  ...
  freedom->set(k1, 14);
  dt->set(k1,15);                                                         // Setting kernel argument #15...
